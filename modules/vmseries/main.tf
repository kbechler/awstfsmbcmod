...
resource "aws_instance" "pa-vm-series" {
  ...
  # user_data            = lookup(each.value, "bootstrap_bucket", null) != null ? base64encode(join("", list("vmseries-bootstrap-aws-s3bucket=", var.buckets_map[each.value.bootstrap_bucket].name, ", mgmt-interface-swap=enable"))) : null
